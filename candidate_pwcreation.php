...
if($_SERVER['REQUEST_METHOD']== 'POST')
{
  ...
  $query="insert into candidate_login(username,password)  values('$candidateid','$pw')";
  ...
  <form  method="POST" id="form">
    ...
    <div class="pw">
        ...
        <div class="inputgroup">
          <input type="text" id="candidateid" name="candidateid" placeholder="Enter your candidateID number">
