...
<div class="topic">
    ...
    <form action="candidatelogincheckup.php" method="POST" class="form">
<center>
<h2 style="margin-top: 0px; color:black " >Candidate login form</h2>
    ...
    <button type="submit" CLASS="btn">submit</button>
        ...
        <nav>
            ...
            <ul>
                ...
                <li><h3>|</h3></li>
                <li><h3><a href="for_pass_cand.php">Forgot password ?</a></h3></li>
            </ul>
        </nav>
    </div>
</form>
