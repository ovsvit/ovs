...
<div class="topic">
    ...
    <form action="voterlogincheck.php" method="POST" class="form">
<center>
<h2 style="margin-top: 0px; color:black " >Voter login form</h2>
   ...
   ?>
    ...
    <button type="submit" CLASS="btn">submit</button>
        ...
        <ul>
            ...
            <li><h3> Not Registered yet?  <a href="voter_Registration_ovs.php">Register here!</h3></li>
        </ul>
            <ul>
